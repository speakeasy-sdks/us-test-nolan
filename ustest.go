...
type SDKOption func(*UsTest)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *UsTest) {
...
func New(opts ...SDKOption) *UsTest {
	sdk := &UsTest{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "2.0.2",
			GenVersion:        "2.192.1",
			UserAgent:         "speakeasy-sdk/go 2.0.2 2.192.1 1.0.0 github.com/speakeasy-sdks/us-test-nolan",
		},
	}
